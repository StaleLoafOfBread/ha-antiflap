...
CONF_MIN_BASE_HOLD_SECONDS = "min_base_hold_seconds"
...
DEFAULT_FLAP_GAP_SECONDS = 30
DEFAULT_HOLD_FACTOR = 1.5
DEFAULT_MAX_HOLD_SECONDS = 600
DEFAULT_MIN_BASE_HOLD_SECONDS = None
...
ATTR_MIN_BASE_HOLD_SECONDS = "min_base_hold_seconds"
